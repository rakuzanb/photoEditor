...
importn = tk.Button(Frame1, bg="#FFD700", text="Import", padx=10, pady=5, command=import_callback)
importButton.grid(row=0, column=0)

saveButton = tk.Button(Frame1, bg="#FFD700", text="Save", padx=10, pady=5, command=save_callback)
saveButton.grid(row=0, column=1)

closeButton = tk.Button(Frame1, bg="#FFD700", text="Close", padx=32, pady=5, command=close_callback)
